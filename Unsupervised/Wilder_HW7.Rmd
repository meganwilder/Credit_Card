---
title: "APAN5420 --- HW 7, Credit Card Transactions"
author: 'Megan Wilder'
date: "7/10/18"
output:
  html_document: 
...
select(
-mean_category_amount,-median_category_amount,-mean_count_trans,
-max_amount,-mean_amount,-median_amount,-count_trans
) %>%
...
select(
-mean_recency_amount,-median_recency_amount,-mean_count_recency,
-max_rec,-mean_rec,-median_rec,-count_rec
) %>%
top_n(-4)  # Use top_n(xx) to select the top xx rows, and top_n(-xx) for the bottom xx rows
...
(source: https://www.rdocumentation.org/packages/MeanShift/versions/1.1-1/topics/msClustering)
